...
// Copyright (c) 2013 BDSM developers
...
const string strMessageMagic = "BDSMCoin Signed Message:\n";
...
// 5,750,000 coins at 300,000 blocks
static const int64 nStartSubsidy = 23 * COIN;
static const int64 nMinSubsidy = 11.5 * COIN;
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("BDSMCoinMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("BDSMCoinMiner : ProcessBlock, block not accepted");
    }
...
void static BitcoinMiner(CWallet *pwallet)
{
    ...
    try { loop {
        ...
        printf("Running BDSMCoinMiner with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
    ...
    {
        printf("BDSMCoinMiner terminated\n");
        throw;
    }
}
